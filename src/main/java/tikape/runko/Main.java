...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        get("/alue/:a_id", (req, res) -> { // Näytetään aluekohtaiset viestiketjut
            ...
            if (debug) {
                Debug.print(vkByArea, "main at 60");
            }
        ...
        get("/ketju/:vk_id", (req, res) -> { // Näytetään aluekohtaiset viestit sivuttain
            HashMap map = new HashMap<>();
        ...
        post("/ketju/:vk_id", (req, res) -> { //lisätään viesti 
            ...
            if (debug) {
                Debug.print(params, "main at 107");
            }
        ...
        post("/alue/:a_id", (req, res) -> { //lisätään ketju            
            ...
            if (debug) {
                Debug.print(params, "main at 126");
            }
